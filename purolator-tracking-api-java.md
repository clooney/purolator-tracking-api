Purolator Tracking API - Java
================================
Use Java to track Purolator shipments with Purolator Tracking API.

Features
--------
- Real-time Purolator tracking.
- Batch Purolator tracking.
- Other features to manage your Purolator tracking.
...
Then, start to track your Purolator shipments.
...
Create a tracking (Real-time tracking):
    ...
    package com.trackingmore.example.purolator;
    ...
    public class CreatePurolatorTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                createTrackingParams.setCourierCode("purolator");
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    public class CreatePurolatorTrackingsExample {
...
Get status of the shipment:
    ...
    public class GetPurolatorTrackingExample {
        ...
        public static void main(String[] args) {
            try {
                ...
                trackingParams.setCourierCode("purolator");
...
Update a tracking by ID:
    ...
    public class UpdatePurolatorTrackingExample {
