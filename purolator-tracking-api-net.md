Purolator Tracking API - .Net
================================
Use .Net to track Purolator shipments with Purolator Tracking API.
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  createTrackingParams.courierCode = "purolator";
      ...
      public class Test
      {
            ...
            static void Main(string[] args)
            {
              try
              {
                  ...
                  getTrackingResultsParams.courierCode = "purolator";
