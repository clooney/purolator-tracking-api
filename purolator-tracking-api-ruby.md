Purolator Tracking API - Node.js
================================
Use Node.js to track Purolator shipments with Purolator Tracking API.
...
Create a tracking (Real-time tracking):
      ...
      begin
        params  = {"tracking_number" => "0301006785462006320995","courier_code"=>"purolator"}
...
Create trackings (Max. 40 tracking numbers create in one call):
    ...
    begin
      params  = [{"tracking_number" => "LK201223662AU","courier_code"=>"purolator"},{"tracking_number" => "LH290032509AU","courier_code"=>"purolator"}]
...
Get status of the shipment:
    ...
    begin
      ...
      # params  = {"courier_code"=>"purolator"}
      # params  = {"tracking_numbers" => "LK201223662AU,LH290032509AU","courier_code"=>"purolator"}
